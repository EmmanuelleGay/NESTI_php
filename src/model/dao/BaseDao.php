...
//SiteUtil::require(PATH_TOOLS.'EntityUtil.php');

//require_once PATH_TOOLS . "EntityUtil.php";
//require_once PATH_TOOLS.'DatabaseUtil.php';

SiteUtil::require('tools/EntityUtil.php');
SiteUtil::require('tools/DatabaseUtil.php');
